...
function LoginPage() {
    ...
    const submitLoginData = async(event) => {
        ...
        try {
            const response = await axios.post(`http://192.168.1.30:8002/login/`, loginData); // Added 'http://' to URL
    ...
    return (
        <div className="container d-flex justify-content-center align-items-center vh-100">
            <div
                ...
                style={{ width: "400px", minHeight: "480px", borderRadius: "15px" }}
            >
                ...
                <form onSubmit={submitLoginData}>
                    ...
                    <div className="d-flex justify-content-center">
                        <button className="btn btn-primary btn-lg px-5 mt-5" type="submit">
                            Submit
                        </button>
                    </div>
                </form>
